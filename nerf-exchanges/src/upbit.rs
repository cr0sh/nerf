...
pub struct GetV1Orders {
    pub market: String,
    pub uuids: Vec<String>, // FIXME: serde-urlencoded does not support serializing UUIDs
...
pub struct DeleteV1Order {
    pub uuid: Option<String>, // FIXME: serde-urlencoded does not support serializing UUIDs
    pub identifier: Option<String>,
}
